                    ...
                    <div class="d-flex gap-2">
                        @foreach ($technologies as $technology)
                            ...
                            <div class="form-check">
                                <input @checked(in_array($technology->id,old('technologies',[]))) type="checkbox" class="form-check-input" id="technology-{{$technology->id}}" value="{{$technology->id}}" name="technologies[]">
